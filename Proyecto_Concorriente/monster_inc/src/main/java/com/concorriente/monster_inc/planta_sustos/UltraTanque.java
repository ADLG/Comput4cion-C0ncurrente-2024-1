...
/**
 * Clase que modelara a los Ultra tanques implementando
 * la interfaz ITanques.
 * @author ADLG.
 * @author DJLP.
 */
public class UltraTanque implements ITanques
{
	int id;
	int capacidad;
	int energia;
	...
	/**
	 * Constructor para los Ultra tanques.
	 * @param id el id del tanque.
	 * @param capacidad la capacidad del tanque.
	 */
	public UltraTanque(int id,int capacidad)
	{
		this.id = id;

...
/**
 * Clase que modelara a los monstruos Pequenos.
 * @author ADLG.
 * @author DJLP.
 */
public class Monstruo_Pequeno extends Monstruo
{
	String nombre;
    ...
    /**
     * Constructor para monstruos Pequenos.
     ...
     */
	public Monstruo_Pequeno (String nombre, int contrasena_locker, String tipo_monstruo, Casillero casillero)
	{
		this.nombre = nombre;
    ...
    /**
     * Constructor para monstruos Pequenos con un tipo extra.
     * @param nombre el nombre del monstruo.
     * @param contrasena_locker la contrasena del casillero del monstruo.
     * @param tipo_monstruo el tipo del monstruo.
     ...
     * @param casillero el casillero del monstruo.
     */
	public Monstruo_Pequeno (String nombre, int contrasena_locker, String tipo_monstruo, String tipo_Mplus, Casillero casillero)
	{
		this.nombre = nombre;
		this.contrasena_locker = contrasena_locker;
		this.tipo_monstruo = tipo_monstruo;

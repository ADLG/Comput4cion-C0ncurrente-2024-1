...
/**
 * Clase que modelara a los Maxi tanques implementando
 * la interfaz ITanques.
 * @author ADLG.
 * @author DJLP.
 */
public class MaxiTanque implements ITanques
{
	int id;
	int capacidad;
	int energia;
	...
	/**
	 * Constructor para los Maxi tanques.
	 * @param id el id del tanque.
	 * @param capacidad la capacidad del tanque.
	 */
	public MaxiTanque(int id,int capacidad)
	{
		this.id = id;

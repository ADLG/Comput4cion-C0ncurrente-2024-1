...
/**
 * Clase que modelara el comportamiento del bano Escamoso.
 * @author ADLG.
 * @author DJLP.
 */
public class Bano_Escamoso extends Bano
{
    Cubiculo [] cubiculos;
    ...
    /**
     * Constructor del bano Escamoso.
     * @param capacidad la capacidad del bano.
     */
    public Bano_Escamoso(int capacidad)
    {
    ...
    {
        if (monstruo.getTipo_monstruo() == "Esc" || monstruo.getTipo_Mplus() == "Esc")
        {  
            ...
            System.out.println("Lo sentimos este es un bano para monstruos Escamosos");
    }

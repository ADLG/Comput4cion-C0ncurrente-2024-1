...
/**
 * Clase que modelara el comportamiento del bano Pequeno.
 * @author ADLG.
 * @author DJLP.
 */
public class Bano_Pequeno extends Bano
{
    Cubiculo [] cubiculos;
    ...
    /**
     * Constructor del bano Pequeno.
     * @param capacidad la capacidad del bano.
     */
    public Bano_Pequeno(int capacidad)
    {
    ...
    {
        if (monstruo.getTipo_monstruo() == "Peq" || monstruo.getTipo_Mplus() == "Peq")
        {  
            ...
            System.out.println("Lo sentimos este es un bano para monstruos Pequenos");
    }

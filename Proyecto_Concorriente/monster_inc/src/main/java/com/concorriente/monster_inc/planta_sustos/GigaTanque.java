...
/**
 * Clase que modelara a los ultra secretos Giga tanques implementando
 * la interfaz ITanques.
 * @author ADLG.
 * @author DJLP.
 */
public class GigaTanque implements ITanques
{
	int id;
	int capacidad;
	int energia;
	...
	/**
	 * Constructor para los Giga tanques.
	 * @param id el id del tanque.
	 * @param capacidad la capacidad del tanque.
	 */
	public GigaTanque(int id,int capacidad)
	{
		this.id = id;

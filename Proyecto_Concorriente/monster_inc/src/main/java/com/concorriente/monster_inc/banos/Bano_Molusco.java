...
/**
 * Clase que modelara el comportamiento del bano Molusco.
 * @author ADLG.
 * @author DJLP.
 */
public class Bano_Molusco extends Bano
{
    Cubiculo [] cubiculos;
    ...
    /**
     * Constructor del bano Molusco.
     * @param capacidad la capacidad del bano.
     */
    public Bano_Molusco(int capacidad)
    {
    ...
    {        
        if (monstruo.getTipo_monstruo() == "Mol" || monstruo.getTipo_Mplus() == "Mol")
        {  
            ...
            System.out.println("Lo sentimos este es un bano para monstruos Moluscos");
    }

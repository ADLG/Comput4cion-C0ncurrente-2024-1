...
/**
 * Clase que modelara a los monstruos Peludos.
 * @author ADLG.
 * @author DJLP.
 */
public class Monstruo_Peludo extends Monstruo
{
	String nombre;
    ...
    /**
     * Constructor para monstruos Peludos.
     ...
     */
	public Monstruo_Peludo (String nombre, int contrasena_locker, String tipo_monstruo, Casillero casillero)
	{
		this.nombre = nombre;
    ...
    /**
     * Constructor para monstruos Peludos con un tipo extra.
     * @param nombre el nombre del monstruo.
     * @param contrasena_locker la contrasena del casillero del monstruo.
     * @param tipo_monstruo el tipo del monstruo.
     ...
     * @param casillero el casillero del monstruo.
     */
	public Monstruo_Peludo (String nombre, int contrasena_locker, String tipo_monstruo, String tipo_Mplus, Casillero casillero)
	{
		this.nombre = nombre;
		this.contrasena_locker = contrasena_locker;
		this.tipo_monstruo = tipo_monstruo;
	...
	public void ponerse_desodorante() throws InterruptedException
	{
		...
		String rest = "\u001B[0m";
		System.out.println(ANSI_GREEN+""+nombre+" pone desodorante..."); Thread.sleep(700); System.out.println("Desodorante puesto"+rest);
	}
	/**
	...
	public void ponerse_casco() throws InterruptedException
	{
		String ANSI_GREEN = "\u001B[32m";
		String rest = "\u001B[0m";
		System.out.println(ANSI_GREEN+""+nombre+" pone casco..."); Thread.sleep(600); System.out.println("Casco puesto"+rest);
	}
	/**
     * El monstruo come.
     * @throws InterruptedException si ocurre un error con el sleep().

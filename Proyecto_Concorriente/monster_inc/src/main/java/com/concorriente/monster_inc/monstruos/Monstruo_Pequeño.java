...
/**
 * Clase que modelara a los monstruos Pequeños.
 * @author ADLG.
 * @author DJLP.
 */
public class Monstruo_Pequeño extends Monstruo
{
	String nombre;
	int contraseña_locker;
    ...
    /**
     * Constructor para monstruos Pequeños.
     * @param nombre el nombre del monstruo.
     * @param contraseña_locker la contraseña del casillero del monstruo.
     * @param tipo_monstruo el tipo del monstruo.
     * @param casillero el casillero del monstruo.
     */
	public Monstruo_Pequeño (String nombre, int contraseña_locker, String tipo_monstruo, Casillero casillero)
	{
		this.nombre = nombre;
		this.contraseña_locker = contraseña_locker;
    ...
    /**
     * Constructor para monstruos Pequeños con un tipo extra.
     * @param nombre el nombre del monstruo.
     * @param contraseña_locker la contraseña del casillero del monstruo.
     * @param tipo_monstruo el tipo del monstruo.
     ...
     * @param casillero el casillero del monstruo.
     */
	public Monstruo_Pequeño (String nombre, int contraseña_locker, String tipo_monstruo, String tipo_Mplus, Casillero casillero)
	{
		this.nombre = nombre;
		this.contraseña_locker = contraseña_locker;
		this.tipo_monstruo = tipo_monstruo;
    ...
    /**
     * El monstruo establece la contraseña de su casillero.
     */
	public void setContraseñaCasillero(){casillero.setContraseña(contraseña_locker);}

    /**
     * El monstruo deja cosas en su casillero.
     * @param elemento el elemento añadido.
     */
	public void dejar_cosasCasillero(String elemento) throws InterruptedException {casillero.añadir_Elemento(elemento);}
     ...
     * @param tanques la lista donde añadira su tanque el monstruo.
     */
     ...
     * @param puertas la lista donde añadira su puerta el monstruo
     */
	...
	/**
     * Hace que el monstruo asuste y añada la energia en tanques.
     * @param tanques los tanques donde se añadira la energia generada por el susto.
     * @param reparadores los reparadores que repararan el tanque si es necesario.
     */
	public void asustar(List<ITanques> tanques,CentroReparacion reparadores)
	{
		...
		String rest = "\u001B[0m";
		puerta.usar();
		if (puerta.getTipo().equals("Niños"))
		{
			for (ITanques i: tanques)
			{
				...
				{
					System.out.println(ANSI_YELLOW+"*El tanque "+i.getId()+" esta lleno, se añadira la energia en otro tanque*\n"+rest);
				}
			}
		}
		else
	...
	/**
     * Hace que el monstruo provoque risa y añada la energia en tanques.
     * @param tanques los tanques donde se añadira la energia generada por la risa.
     * @param reparadores los reparadores que repararan el tanque de ser necesario.
     */

...
public class Contador implements Runnable {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Contador obteniendo 20000 (o aproximado) usando Thread.sleep()");
        h1.start();h2.sleep(100);h2.start();
        ...
        System.out.println("Contador obteniendo 30000 (o aproximado) usando Thread.sleep()");
        h3.start();h4.start();
        h4.interrupt();
        h3.join();h4.join();
        
        System.out.println("EL VALOR ES: " + c1.getValor());
    }
}
